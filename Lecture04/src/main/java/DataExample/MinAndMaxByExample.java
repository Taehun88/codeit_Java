...
public class MinAndMaxByExample {
    public static void main(String[] args) {
        ...
        Optional<String> minFruit = fruits.stream().collect(Collectors.minBy(Comparator.naturalOrder()));
        Optional<String> maxFruit = fruits.stream().collect(Collectors.maxBy(Comparator.naturalOrder()));
