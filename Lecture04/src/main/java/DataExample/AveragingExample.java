...
public class AveragingExample {
    public static void main(String[] args) {
        ...
        double intAvg = ints.stream().collect(Collectors.averagingInt(n -> n));
        double doubleAvg = doubles.stream().collect(Collectors.averagingDouble(n -> n));
        double longAvg = longs.stream().collect(Collectors.averagingLong(n -> n));
